...
const TRIP_DAYS_AMOUNT = 3;
const TRIP_EVENTS_AMOUNT = 4;
...
render(tripEventsElement, createEditTripEventTemplate());
render(tripEventsElement, createTripDaysTemplate());

const tripDaysElement = document.querySelector(`.trip-days`);
new Array(TRIP_DAYS_AMOUNT)
  .fill(``)
